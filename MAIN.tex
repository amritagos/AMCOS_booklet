...
\input{abstracts/tex/t\type_sandip} % Sandip Khan
\input{abstracts/tex/t\type_rane} % Kaustubha Rane
\input{abstracts/tex/t\type_jumpa} % Jhumpa Adhikari
\clearpage
\input{abstracts/tex/t\type_shantanu} % Shantanu Maheshwari
\input{abstracts/tex/t\type_punna} % Sudeep Punnathanam
\clearpage
...
\input{abstracts/tex/t\type_musharaf} % Sk Musharaf Ali
...
\input{abstracts/tex/p\type_shubham} % Shubham Tiwari
