...
\newcommand{\STtag}{\tikz[baseline={([yshift=-.8ex]current bounding box.center)}]  \node[circle, inner sep=2pt, minimum size=0.5em, color=black, fill=\ITcolor]{\small \bfseries ST};} %colored circle with tag
...
\newcommand{\ST}[5]{%
  #1 &\cellcolor{\ITcolor}ST&{\bfseries#2}\newline #4&&#5 \\ \hline}
\newcommand{\IT}[5]{%
